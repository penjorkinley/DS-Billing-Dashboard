...
export function PricingSection() {
  ...
  const pricingOptions = [
    {
      icon: Clock,
      title: "Validity-Based Subscription",
      subtitle: "Perfect for predictable usage patterns",
      features: [
        "Monthly - Nu. 5 per signature",
        "Quarterly - Nu. 5 per signature",
        "Half Yearly - Nu. 5 per signature",
        "Annually - Nu. 5 per signature",
      ],
      note: "Charged at the end of validity period based on actual usage",
      gradient: "from-ndi-primary to-ndi-secondary",
    },
    {
      icon: CreditCard,
      title: "Usage-Based Prepaid",
      subtitle: "Ideal for bulk signature requirements",
      features: [
        "Single Signatory: Nu. 5 per signature",
        "Multiple Signatories: Nu. 8 per signature",
        "Bulk purchase options available",
        "No expiry on purchased signatures",
      ],
      note: "Purchase signature credits in advance and use as needed",
